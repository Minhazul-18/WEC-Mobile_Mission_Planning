...
for k = 1: pop_size
    ...
    path_lat =[path_lat, sf_lat]; % First and last latitude has to be equal
    path_long = [path_long, sf_long]; % First and last longitude has to be equal
